let questions = [
  ...
  [
    ...
    },
    {
      ...
      variants: ['Подниму руки за голову.', 'Достану оружие и попытаюсь их затулить.', 'Напишу в рацию, чтобы меня забрали.', 'Убегу от них подальше.'],
      trueAnswer: ['3', '4']
    }
  ],
  //4 Адекватность
  [
    ...
    },
    {
      ...
      variants: ['Сильно удивлюсь, вылечусь и поеду домой на такси.', 'Расстроюсь, ведь я боюсь больниц. Позвоню другу, попрошу его меня забрать и отвезти домой.', 'Позвоню друзьям, опишу подонков и мы вместе поедем с ними разбираться.', 'Напишу в рацию, попрошу коллег меня забрать и мы поедем задерживать нарушителей.'],
      trueAnswer: ['1', '2']
    },
    {
      ...
      variants: ['Попрошу показать нашивку.', 'Попрошу уточнить, на каком основании.', 'Подчинюсь приказу и отойду.', 'Буду молча стоять и наблюдать.'],
      trueAnswer: ['2', '4']
    }
  ],
  //5 Отыгровка /me
  ...
  [
    ...
    },
    {
      ...
      variants: ['Все что не касается реального мира.', 'Все что касается GTA.', 'Все что касается жизни персонажей в игре.', 'Все ответы верны.'],
      trueAnswer: ['3']
    },
    {
      question: 'Что считается нонРП поведением?',
      variants: ['Могу купить оружие и пойти растрелять целую банду.', 'Подойти к человеку и спросить, не является ли он богом.', 'Гулять по Чиллиаду и случайно упасть с него.', 'Написать в WN: "Продаю тачку за 300к."'],
      trueAnswer: ['1']
    }
  ],
  //10
  [
    ...
    {
      question: 'У вас спросили, кто такие BLOODS? ((IC)) Как вы можете ответить?',
      variants: ['Какая-то компания. Кажется, они делали чешки.', 'Всем известная банда.', 'Это когда много крови.', 'Затрудняюсь ответить.'],
      trueAnswer: ['1', '3', '4']
    },
    {
      question: 'Вы потерялись в городе когда гуляли. Вам нужно вернуться домой. Что вы можете попасть домой? ((IC))',
      variants: ['Вызову такси.', 'Открою карту в телефоне и по ней вернусь домой.', 'Релогнусь и заспавнюсь дома.', 'Очень расстроюсь и грустно пойду в неизвестном направлении в надежде попасть домой.'],
      trueAnswer: ['1', '2', '4']
    }
  ]
]

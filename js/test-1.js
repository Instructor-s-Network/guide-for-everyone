let questions = [
  ...
  [
    ...
    {
      question: 'Какая отыгровка была написана человеком неправильно?',
  ...
  [
    ...
    },
    {
      ...
      variants: ['Интро Сонаты.', 'In Character.', 'Информация, относящаяся к процессу РолеПлея.', 'Иван Степаныч.'],
      trueAnswer: ['1', '4']
    },
    {
      question: 'У вас спросили, кто такой Дядя Миша? Как вы можете ответит? ((IC))',
  ...
  [
    ...
    },
    {
      ...
      variants: ['Какая-то компания. Кажется, они ремонтировали машины.', 'Мексиканская банда.', 'Фанаты желтого цвета.', 'Частная организация, занимаются пошивом футболок.'],
      trueAnswer: ['2']
    },
    {
